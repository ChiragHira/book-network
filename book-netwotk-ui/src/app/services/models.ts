...
export type { BorrowBookResponse } from './models/borrow-book-response';
...
export type { PageResponseBorrowBookResponse } from './models/page-response-borrow-book-response';
